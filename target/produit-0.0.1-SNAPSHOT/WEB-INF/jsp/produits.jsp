...
<div id="conteneur">
	...
	<c:forEach items="${ produits }" var="mapProduits" varStatus="boucle">
        ...
        <div class="block_produit">
        	<div class="prix"><label>${ mapProduits.value.prix }&euro;</label></div>
       		<a href="${ mapProduits.value.lienSiteOff }">
           	<img src="${ mapProduits.value.lienImage }" id="axe"/>
      		</a>
        	<div class="description">${ mapProduits.value.nom }</div>
    	</div>
